...
import { setTechEditModal, updateTech } from "../../actions/techsActions";

const EditTechModal = ({ setTechEditModal, updateTech, tech: { current, showEditModal } }) => {
    ...
    const closeTechModal = () => {
        setTechEditModal(false);
    };

    return (
        <Transition.Root show={showEditModal} as={Fragment} onClose={() => closeTechModal()}>
            <Dialog
                as="div"
                static
